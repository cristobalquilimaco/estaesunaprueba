          ...
          <form onSubmit={handleSearch} className="relative mb-8">
            <div className="flex">
              <input
                ...
                className="flex-1 px-6 py-4 text-lg border border-gray-300 dark:border-gray-600 rounded-l-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
